export const navigations = [
    ...
    { name: 'KYC', icon: 'assignment', path: '/material/kycTable', iconText: 'T' },
    { name: 'Orders', icon: 'shopping_cart', path: '/material/orderTable', iconText: 'T' },
    { name: 'Settings', icon: 'settings', path: '/material/settings', iconText: 'T' },

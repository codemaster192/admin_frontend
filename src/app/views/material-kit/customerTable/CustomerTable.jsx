...
export default function PaginationTable() {
    ...
    const [anchorEls, setAnchorEls] = useState({}); // Store anchorEl for each row
    ...
    const openMenu = (index) => Boolean(anchorEls[index]);
                                    ...
                                    <TableRow hover role="checkbox" tabIndex={-1} key={`tableRow${key}`}>
                                        ...
                                        >
                                            <IconButton
                                                ...
                                                id={`demo-customized-btn${key}`}
                                                aria-controls={
                                                    openMenu(key) ? `demo-customized-menu${key}` : undefined
                                                }
                                                aria-haspopup="true"
                                            ...
                                            <Menu
                                                id={`demo-customized-menu${key}`}
                                                MenuListProps={{
                                                    'aria-labelledby': `demo-customized-label${key}`
                                                }}
